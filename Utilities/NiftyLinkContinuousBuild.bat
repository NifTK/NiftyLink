...
@REM ***** Usage:                                                                   *****
@REM *****                                                                          *****
@REM *****   NiftyLinkContinuousBuild.bat  [<branch>]  [Release|Debug]  [<folder>]  *****
@REM *****                                                                          *****
@REM ***** The defaults are "development", "Release" and "NiftyLink".               *****
@REM *****                                                                          *****
@REM ***** E.g. if BUILD_ROOT is "C:" (default) then the following command          *****
@REM *****                                                                          *****
@REM *****     NiftyLinkContinuousBuild.bat development Debug a                     *****
@REM *****                                                                          *****
@REM ***** will create the directories C:\a (sources), C:\a-B and C:\a-1301002-logs *****
@REM ***** (build and test output), and will make a Debug build of the development  *****
@REM ***** branch.                                                                  *****
@REM *****                                                                          *****
@REM ************************************************************************************
...
@set "BATFILEPATH=%BUILD_BIN%\NiftyLink-build\StartVS_%BCONF%.bat"
@set PATHSTRING=" "
...
@echo.
@echo ***** NiftyLink Continuous Build Script Successfully FINISHED *****
@endlocal
@endlocal