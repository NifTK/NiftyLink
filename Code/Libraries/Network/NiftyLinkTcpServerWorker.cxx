...
=============================================================================*/
#include "NiftyLinkTcpServerWorker.h"
...
//-----------------------------------------------------------------------------
NiftyLinkTcpServerWorker::NiftyLinkTcpServerWorker(QTcpSocket *socket, QObject *parent)
: QObject(parent)
, m_Socket(socket)
...
{
  m_MessagePrefix = QObject::tr("NiftyLinkTcpServerWorker(%1)").arg(m_Socket->socketDescriptor());
  ...
  QLOG_INFO() << QObject::tr("%1::NiftyLinkTcpServerWorker() - created.").arg(m_MessagePrefix);
}


//-----------------------------------------------------------------------------
NiftyLinkTcpServerWorker::~NiftyLinkTcpServerWorker()
{
  QLOG_INFO() << QObject::tr("%1::~NiftyLinkTcpServerWorker() - destroyed").arg(m_MessagePrefix);
}


//-----------------------------------------------------------------------------
void NiftyLinkTcpServerWorker::OnSocketDisconnected()
{
...
//-----------------------------------------------------------------------------
void NiftyLinkTcpServerWorker::OnSocketError(QAbstractSocket::SocketError error)
{
  QLOG_INFO() << QObject::tr("%1::OnSocketError(%2)").arg(objectName()).arg(error);
  emit SocketError(m_Socket->peerPort(), error);
}


//-----------------------------------------------------------------------------
void NiftyLinkTcpServerWorker::OnSocketReadyRead()
{
