...
#include "TestOIGTLinkTrackingClient.h"
...
//-----------------------------------------------------------------------------
TestOIGTLinkTrackingClient::TestOIGTLinkTrackingClient(
...
{
  this->setObjectName("TestOIGTLinkTrackingClient");
}
...
//-----------------------------------------------------------------------------
void TestOIGTLinkTrackingClient::Start()
{
  ...
  msg->SetDeviceName("TestOIGTLinkTrackingClient");
  msg->SetString("STATS");
  msg->Pack();
...
int main(int argc, char** argv)
{
  ...
  std::cout << "TestOIGTLinkTrackingClient: host = " << hostName << "." << std::endl;
  std::cout << "TestOIGTLinkTrackingClient: port = " << port << "." << std::endl;
  std::cout << "TestOIGTLinkTrackingClient: fps = " << fps << "." << std::endl;
  std::cout << "TestOIGTLinkTrackingClient: total = " << total << "." << std::endl;
  std::cout << "TestOIGTLinkTrackingClient: objects = " << objects << "." << std::endl;
  std::cout << "TestOIGTLinkTrackingClient: Instantiating client." << std::endl;
  ...
  // Start client.
  niftk::TestOIGTLinkTrackingClient client(hostName, port, fps, total, objects);

  std::cout << "TestOIGTLinkTrackingClient: Creating app." << std::endl;

  QApplication app(argc, argv);

  std::cout << "TestOIGTLinkTrackingClient: Launching app." << std::endl;
